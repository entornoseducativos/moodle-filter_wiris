...
$string['rendertype_help'] = 'Specifies how to render the formulas.<br>- PHP: calls the Wiris rendering service from the filter module<br>- MathJax: delegates the rendering to MathJax in order to reduce requests to the Wiris servers<br>- JavaScript: gets the WIRIS rendering engine in the client via JavaScript in order to reduce requests from the Moodle server to the Wiris servers';
